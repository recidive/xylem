...
Model.compile = function(connection, settings) {
  ...
  MockModel.list = function(query, callback) {
    Model.do(connection, settings, 'list', query, callback);
  };

  MockModel.get = function(key, callback) {
    Model.do(connection, settings, 'get', key, callback);
  };
  ...
  MockModel.destroy = function(key, callback) {
    Model.do(connection, settings, 'destroy', key, callback);
  };
