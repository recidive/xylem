...
class Schema {
   ...
   * @return {Array|Boolean} Array with errors if validation fails or true if it
   *   passes.
   */
  check(data) {
    // @todo
   ...
   * Validate data against schema.
   *
   * @param {Object} fieldSettings Field settings from schema.
   * @param {Mixed} value Data to be validated.
   */
  checkField(fieldSettings, value) {
